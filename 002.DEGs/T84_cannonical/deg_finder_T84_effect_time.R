...
metadata = metadata[metadata$genotype == 'T84', ]
...
write.table(sorted_filtred_results, file=paste(results_dir, '/cannonical/effect_time_84.for.tsv', sep=''), quote=FALSE, sep='\t')
write.table(anti_results, file=paste(results_dir, '/cannonical/effect_time_84.anti.tsv', sep=''), quote=FALSE, sep='\t')
